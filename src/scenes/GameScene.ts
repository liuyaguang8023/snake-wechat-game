...
export class GameScene implements Scene {
  ...
  constructor(private sceneManager: SceneManager, data: GameSceneData) {
    this.mode = data.mode;
  ...
  private resetGame(): void {
    ...
    this.effects.bind((GameContext.renderer as any)?.ctx);
  }
  ...
  private gameTick(): void {
    ...
    const collectedPowerUp = this.fieldPowerUps.findIndex(
      (fp) => fp.pos.row === this.snake.head.row && fp.pos.col === this.snake.head.col
    );
